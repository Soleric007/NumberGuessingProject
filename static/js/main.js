    ...
    authModal.innerHTML = `
        <div id="modal-bg" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 transition-opacity duration-300">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg w-80 text-center">
                ...
                <input type="text" id="username" placeholder="Username" class="mt-3 p-2 w-full border rounded text-black">
                 <input type="email" id="email" placeholder="Email" class="mt-3 p-2 w-full border rounded text-black">
                <input type="password" id="password" placeholder="Password" class="mt-3 p-2 w-full border rounded text-black">
