...
//         if (!gameId) {
//             console.error("Game ID is missing! Start a new game first.");
...
//         if (attempts >= maxAttempts || submitButton.disabled) {
//             return;
//         }
...
//             let hintMessage = data.hint ? data.hint : "No hint provided";
...
//             // ✅ If correct, stop game immediately
...
//             // 🚨 If attempts are exhausted, stop game immediately
...
//             if (response.ok) console.log("Score submitted successfully!");
//         } catch (error) {
